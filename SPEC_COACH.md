...
- **Long cours ou court terme** *(16 septembre 2026)* : chaque projet porte une étiquette — la basse ou la cyber tiennent l'année, un bot tient trois semaines. **Aucune règle n'en dépend, et c'est délibéré.** La vitesse d'avancement varie, la roadmap change, et une mécanique adossée à cette étiquette — un quota par type, une date de fin, un nombre d'étapes — finirait fausse au premier imprévu. Elle sert à relire sa liste, et se change d'un clic à tout moment.
