...
- **Projet long ou projet court** *(16 septembre 2026)* : chaque projet porte une étiquette — la basse ou la cyber tiennent l'année, un bot tient trois semaines. **Aucune règle n'en dépend, et c'est délibéré.** La vitesse d'avancement varie, la roadmap change, et une mécanique adossée à cette étiquette — un quota par type, une date de fin, un nombre d'étapes — finirait fausse au premier imprévu. Elle sert à relire sa liste, et se change d'un clic à tout moment.
...
Onze effets, énumération fermée, en trois familles :

- **le sas** : le rallonger (+10, +20, +45 min), en ouvrir un second, en épargner le coût en journée de réseaux, sauter ses soixante secondes d'attente, en mettre un de côté pour demain, le faire courir **jusqu'au couvre-feu**. Même la carte légendaire s'y arrête : rien n'ouvre la nuit ;
- **le silence** : aucune notification du jour. Ce qui se tait est le **rappel**, jamais le cadre — blocage, couvre-feu et projet du jour ne bougent pas d'un pouce ;
- **la soirée** *(16 septembre 2026)*, et c'est la famille la plus surveillée. « Carte blanche » laisse **n'importe quel projet** tenir le rendez-vous — le travail reste dû, c'est le choix du projet qui est rendu. « Petit pas » descend la barre du soir à **quinze minutes** : le démarrage reste dû, et c'est lui qui coûte le plus cher. « Report » déplace la séance à demain, **qui en portera deux** — rien n'est effacé, la dette se paie. « Trêve » rend la journée neutre, hors quota, en posant un vrai jour off du §11.5.

**Une seule carte efface une soirée, et c'est la limite haute du système.** « Trêve » est légendaire pour cette raison précise. Les trois autres déplacent le travail, changent son objet ou allègent sa barre ; aucune ne le supprime. Au-delà d'une carte qui efface, une carte remplacerait une séance — et l'ancienne interdiction du §17 redeviendrait nécessaire. Un test compte ces cartes et échoue s'il y en a deux.
